...
class ShopPage(BasePage):
    ...
    def check_cart(self):
        cart_count_element = self.driver.find_element(*ShopPageLocators.CART_COUNT)
        return cart_count_element

class CartPage(BasePage):
    def edit_cart(self):
        item_quantity_element =  self.driver.find_element(*CartPageLocators.CART_QUANTITY)
    ...
    def check_cart(self):
        cart_count_element = self.driver.find_element(*CartPageLocators.CART_COUNT)
        return cart_count_element